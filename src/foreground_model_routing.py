...
# ---------------------------------------------------------------------------
# SIH26117 MRPL Poly-Model Open-Weight Presets
# ---------------------------------------------------------------------------
POLY_MODEL_INDUSTRIAL_PRESETS = {
    "vision_pid": "Qwen/Qwen2.5-VL-7B-Instruct",
    "engineering_calc": "Qwen/Qwen2.5-Coder-32B-Instruct",
    "turnaround_reasoning": "deepseek-ai/DeepSeek-R1-Distill-Qwen-32B",
    "executive_general": "meta-llama/Llama-3.3-70B-Instruct",
}


def resolve_industrial_model_for_task(domain: str) -> str:
    """Resolve specialized open-weight model for an industrial domain task."""
    domain_map = {
        "industrial_pid_inspection": POLY_MODEL_INDUSTRIAL_PRESETS["vision_pid"],
        "industrial_ndt_calc": POLY_MODEL_INDUSTRIAL_PRESETS["engineering_calc"],
        "industrial_process_calc": POLY_MODEL_INDUSTRIAL_PRESETS["engineering_calc"],
        "industrial_turnaround_planning": POLY_MODEL_INDUSTRIAL_PRESETS["turnaround_reasoning"],
    }
    return domain_map.get(domain, POLY_MODEL_INDUSTRIAL_PRESETS["engineering_calc"])
