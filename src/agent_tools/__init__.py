...
from .industrial_tools import (
    CalcVesselThicknessApi510Tool,
    CalcPipeThicknessApi570Tool,
    CalcPumpHydraulicsTool,
    CalcHeatExchangerDutyTool,
    OptimizeCrudeBlendTool,
    InspectPidDrawingTool,
    VerifyAuditLogTool,
    PlanRefineryTurnaroundTool,
)

TOOL_HANDLERS = {
    "calc_vessel_thickness_api510": CalcVesselThicknessApi510Tool().execute,
    "calc_pipe_thickness_api570": CalcPipeThicknessApi570Tool().execute,
    "calc_pump_hydraulics": CalcPumpHydraulicsTool().execute,
    "calc_heat_exchanger_duty": CalcHeatExchangerDutyTool().execute,
    "optimize_crude_blend": OptimizeCrudeBlendTool().execute,
    "inspect_pid_drawing": InspectPidDrawingTool().execute,
    "verify_audit_log": VerifyAuditLogTool().execute,
    "plan_refinery_turnaround": PlanRefineryTurnaroundTool().execute,
...
TOOL_TAGS = {"bash", "python", "web_search", "web_fetch", "read_file", "write_file", "edit_file",
             ...
             "manage_notes",
             # MRPL Industrial Tools (SIH26117)
             "calc_vessel_thickness_api510", "calc_pipe_thickness_api570",
             "calc_pump_hydraulics", "calc_heat_exchanger_duty",
             "optimize_crude_blend", "inspect_pid_drawing", "verify_audit_log",
