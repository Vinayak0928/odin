...
- [ ] I actually ran the app (`docker compose up` or `python app.py`) and verified the change works end-to-end. Type-checks and unit tests are not enough.
...
- [ ] **Style match**: the change uses the Workbench's existing visual language. Specifically:
