# Contributing to MRPL Sovereign Industrial AI Workbench
...
The Sovereign Workbench has an intentional visual style. PRs that ignore it will be closed without merge, no matter how correct the underlying code is.
