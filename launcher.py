...
if getattr(sys, 'frozen', False):
    ...
    def show_splash_instantly():
        ...
        try:
            splash_root = tk.Tk()
            splash_root.title("MRPL Sovereign Workbench")
            ...
            tk.Label(splash_root, text="MRPL Sovereign AI", font=("Segoe UI", 20, "bold"), bg="#1a1c23", fg="#e06c75").pack(pady=(22, 2))
...
def setup_system_tray(url):
    try:
        ...
        menu = (
            pystray.MenuItem('Open Sovereign Workbench', lambda icon, item: on_open_browser(icon, item, url), default=True),
